  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        "bg-accent inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-background data-[state=active]:text-foreground dark:data-[state=active]:text-muted-foreground data-[state=active]:shadow-sm",
